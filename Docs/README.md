# RoadSenseAI – Project Documentation

This folder contains the main documentation materials for the **RoadSenseAI capstone project**.

The documentation is organized by project phase:

## Phase B – Final Project Documentation
...
The following demo video is part of **Phase B** and presents the final RoadSenseAI system:
...
## Phase A – Initial Project Documentation
